...
import 'package:flutter_application_1/layout/shop_App/modules/register/cubit_register/register_cubit.dart';
...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ShopRegisterCubit, ShopeRegisterState>(
